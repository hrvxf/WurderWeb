import type { SetupStep } from "@/lib/company-game/companyGameOptions";

type CreateCompanyGameStepperProps = {
  step: SetupStep;
};

export default function CreateCompanyGameStepper({ step }: CreateCompanyGameStepperProps) {
