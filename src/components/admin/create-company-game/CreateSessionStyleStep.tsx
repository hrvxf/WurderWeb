import SessionStyleOptionCard from "@/components/admin/create-company-game/SessionStyleOptionCard";
import {
  gameModeOptions,
  lengthOptions,
...
type CreateSessionStyleStepProps = {
...
export default function CreateSessionStyleStep({
  gameMode,
  length,
...
function ModeDescriptionPanel({ option }: { option: GameModeOption }) {
  return (
    <aside className="rounded-xl border border-white/15 bg-white/[0.03] p-4 sm:p-5">
      ...
      <p className="mt-4 rounded-lg border border-white/10 bg-black/20 px-3 py-2 text-xs text-white/75">
