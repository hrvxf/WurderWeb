  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden">
      <div className="pointer-events-none fixed inset-0 -z-10">
        <div className="absolute -left-24 top-16 h-56 w-56 rounded-full bg-white/8 blur-3xl" />
        <div className="absolute -right-20 top-8 h-48 w-48 rounded-full bg-white/6 blur-3xl" />
      </div>
