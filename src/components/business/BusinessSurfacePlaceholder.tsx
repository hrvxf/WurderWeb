  ...
  return (
    <AuthGate>
      <section className="mx-auto w-full max-w-[44rem] space-y-4 py-4">
        <div className="rounded-2xl border border-white/15 bg-black/25 p-5 sm:p-6">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <Link
              ...
              className="inline-flex items-center justify-center rounded-xl bg-slate-100 px-4 py-2.5 text-sm font-semibold text-slate-900 transition hover:bg-white"
            >
              Start session
            </Link>
            <Link
